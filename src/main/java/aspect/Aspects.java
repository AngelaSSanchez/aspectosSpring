...
public class Aspects {
    ...
    @After("@annotation(aspect.TimeAnnotation)")
    public void consejoF(JoinPoint jp) {
        System.out.println("=== Consejo Despues de ejecutar metodos (time):" + jp.getSignature().getName());
    }
    
    @Around("@annotation(aspect.TimeAnnotation)")
    public Object consejoG(ProceedingJoinPoint pjp) throws Throwable {
        System.out.println("=== antes time......");
        Object obj = pjp.proceed();
        System.out.println("=== ......despues time");
        return obj;
    }
